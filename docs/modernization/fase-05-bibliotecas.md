...
- [x] PDFBox 3.x — extração de texto de PDF funciona
- [x] POI 5.x — importação de patentes de todos os formatos suportados
- [x] PrimeFaces 14 — upload e download de arquivos funciona
- [x] `mvn clean package` passa sem erros
- [x] Zero dependências com CVE crítico conhecido (verificar via `mvn dependency-check:check` — Fase 8)
