...
- [x] Lucene 9.12.0 no classpath; zero referências a `org.apache.lucene.util.Version`
- [x] Índice criado e consultado sem erro
- [x] Harmonização de depositantes retorna sugestões corretas
- [x] Harmonização de inventores retorna sugestões corretas
- [x] Testes de regressão Fast-Join passam
- [x] Reindex documentado/automatizado na primeira execução
