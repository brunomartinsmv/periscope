...
- [x] Zero imports `com.github.jmkgreen.morphia.*`
- [x] Zero imports `com.mongodb.Mongo`, `DB`, `DBCollection`, `DBCursor`
- [x] Zero imports `com.mongodb.gridfs.*` (legado)
- [x] Zero `MapReduceCommand` / `AggregationOutput`
- [x] GridFS funciona (upload + download de arquivos de patente)
- [x] Seed data carrega na inicialização
- [x] Repositórios de relatório retornam dados corretos
- [x] Conexão configurável via `MONGODB_URI`
